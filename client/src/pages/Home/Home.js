...
const Home = () => {
  ...
  return (
    <main>
      <div className="flex-row justify-center home-page-styling">
        <div className="mb-3 mx-auto p-2 h-100 text-center">
        <em><h1 className='text-danger'>Welcome to Full Moon Manor</h1></em>
          <div className='py-5 custom-fade-in'>
            <p>
          ...
          {Auth.loggedIn() ?
            <Link to='/room/Torture Room'> <Button variant='danger'>Wake Up</Button> </Link>
            :
